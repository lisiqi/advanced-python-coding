...
# Create the parser
parser = argparse.ArgumentParser(description="A script that demonstrates optional arguments.")

# Add positional arguments
parser.add_argument('filename', nargs='?', type=str, default="myfile.txt", help='The name of the file to write to')
parser.add_argument('message', nargs='?', type=str, default="Hello World again", help='The message to write to the file')

# Add optional arguments
parser.add_argument('--verbose', '-v', action='store_true', help='Increase output verbosity')
parser.add_argument('--repeat', '-r', type=int, default=1, help='Number of times to repeat the message')
